...
--TC20
	--Cambio en la tabla para otras consultas y mostrar el monto total
	ALTER TABLE ProcesoPago
	ADD COLUMN total INT,
	ADD CONSTRAINT chk_total_non_negative CHECK (total >= 0),
	-- TC20 Restriccion medios de pagos validos
	ADD CONSTRAINT chk_metodo_pago CHECK (metodo_pago IN ('Credito', 'Debito', 'Transferencia'));
